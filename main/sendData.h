...
//////////////////////////////////////////////////////
  ...
  const char WiFiSSID[] = "TP-LINK_1560";
  const char WiFiPSK[] = "11313762";
#endif
...
//////////////////////////////////////////////////////
  ...
  String MyWriteAPIKey="NSZEVSUCVQEWO6KX"; // Escribe la clave de tu canal ThingSpeak
#else 
...
void send(int paco[]) {
    ...
    for ( int i = 1; i < NUM_FIELDS_TO_SEND+1; i++ ){
          data[ i ] = paco[i];
